      ...
      <div class="eg-profile-container eg-profile-container--ref">
            ...
            <div class="eg-profile-ref-avatar position-relative" style="overflow: hidden;">
              ...
              <?php if ($editMode): ?>
                <label for="profile_image"
                  class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center m-0"
                  style="background: rgba(0,0,0,0.5); cursor: pointer; opacity: 0; transition: opacity 0.2s;"
                  onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0" title="Change Profile Picture">
          ...
          <form method="post" enctype="multipart/form-data" class="eg-profile-ref-form">
            ...
            <div class="eg-profile-ref-grid">
              <div class="eg-profile-ref-field">
                ...
                <input type="text" class="eg-profile-ref-input" id="nickname" name="nickname"
                  value="<?= htmlspecialchars($profile['nickname']) ?>" placeholder="Display name" />
              </div>
              <div class="eg-profile-ref-field">
                <label class="eg-profile-ref-label" for="first_name">First name</label>
                <input type="text" class="eg-profile-ref-input" id="first_name" name="first_name"
                  value="<?= htmlspecialchars($profile['first_name']) ?>" required />
              </div>
              <div class="eg-profile-ref-field">
                <label class="eg-profile-ref-label" for="last_name">Last name</label>
                <input type="text" class="eg-profile-ref-input" id="last_name" name="last_name"
                  value="<?= htmlspecialchars($profile['last_name'] ?? '') ?>" />
              </div>
              <div class="eg-profile-ref-field">
                <label class="eg-profile-ref-label" for="date_of_birth">Date of birth</label>
                <input type="date" class="eg-profile-ref-input" id="date_of_birth" name="date_of_birth"
                  value="<?= htmlspecialchars($profile['date_of_birth']) ?>" />
              </div>
              <div class="eg-profile-ref-field">
                <label class="eg-profile-ref-label" for="gender">Gender</label>
                <input type="text" class="eg-profile-ref-input" id="gender" name="gender"
                  value="<?= htmlspecialchars($profile['gender']) ?>" placeholder="e.g. Male" />
              </div>
              <div class="eg-profile-ref-field eg-profile-ref-field--wide">
                <label class="eg-profile-ref-label" for="address">Address</label>
                <input type="text" class="eg-profile-ref-input" id="address" name="address"
                  value="<?= htmlspecialchars($profile['address']) ?>" />
              </div>
              <div class="eg-profile-ref-field">
                <label class="eg-profile-ref-label" for="phone">Phone number</label>
                <input type="text" class="eg-profile-ref-input" id="phone" name="phone"
                  value="<?= htmlspecialchars($profile['phone']) ?>" />
              </div>
              <div class="eg-profile-ref-field">
                <label class="eg-profile-ref-label" for="email">Email</label>
                <input type="email" class="eg-profile-ref-input" id="email" name="email"
        ...
        <?php else: ?>
          ...
          <?php if ($employeeCode !== ''): ?>
            ...
            <div>
              <button type="button" id="downloadBarcodeBtn" class="eg-profile-ref-btn eg-profile-ref-btn--primary">Download
                Barcode</button>
            </div>
          <?php else: ?>
