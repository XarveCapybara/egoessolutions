...
if (!$hasEmployeesTable || !$hasAttendanceLogs || $userId <= 0) {
  ...
  if (!$empRow) {
    $error = 'Admin account is not linked to an employee record.';
  } else {
    ...
    if (empty($logRows)) {
      $error = 'No attendance for this period.';
    } else {
        ...
        <div class="eg-panel">
          ...
          <form method="get" class="row g-3 align-items-end mb-4">
            ...
            <div class="col-12 col-sm-4 col-lg-3<?= $period === 'month' ? ' d-none' : '' ?>" id="weekFieldWrap">
              ...
              <input type="date" id="week" name="week" class="form-control"
                value="<?= htmlspecialchars($weekInput, ENT_QUOTES, 'UTF-8') ?>" />
            </div>
            <div class="col-12 col-sm-4 col-lg-3<?= $period === 'month' ? '' : ' d-none' ?>" id="monthFieldWrap">
              <label class="form-label" for="month">Month</label>
              <input type="month" id="month" name="month" class="form-control"
                value="<?= htmlspecialchars($monthInput, ENT_QUOTES, 'UTF-8') ?>" />
            </div>
            <div class="col-12 col-sm-4 col-lg-3">
                    ...
                    <div class="eg-payslip-net-box">
                      <div class="eg-payslip-net-inner">
                        ...
                        <div class="eg-payslip-net-deductions-summary">
                          ...
                          <div class="eg-payslip-num"><span
                              class="eg-payslip-total-ded-amount"><?= $fmtMoney($totalDeductionsAll) ?></span></div>
                        </div>
                      </div>
                      <div class="eg-payslip-net-total">Net Pay: PHP <span
                          class="eg-payslip-net-amount"><?= $fmtMoney($showDeductions ? $net : $netWithConfigurableLinesAsZero) ?></span>
                      </div>
                    </div>
                  </div>
                </div>
