...
INSERT INTO `attendance_logs` (`id`, `employee_id`, `office_id`, `log_date`, `time_in`, `time_out`, `status`) VALUES
	(6, 5, 1, '2026-03-24', '2026-03-25 00:32:05', '2026-03-25 00:32:48', 'present');
...
INSERT INTO `offices` (`id`, `name`, `address`, `team_leader`, `is_active`, `team_leader_user_id`) VALUES
	(1, 'office1', 'Tirad Pass', 'starktony', 1, 12),
	(3, 'office2', 'Terminal', 'jobert', 1, 8);
...
-- Dumping data for table egoessolution.users: ~7 rows (approximately)
