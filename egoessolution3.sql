...
INSERT INTO `attendance_logs` (`id`, `employee_id`, `office_id`, `log_date`, `time_in`, `time_out`, `status`, `late_minutes`, `deduction_amount`) VALUES
	(6, 5, 1, '2026-03-24', '2026-03-25 00:32:05', '2026-03-25 00:32:48', 'present', NULL, NULL),
	(7, 6, 1, '2026-03-25', '2026-03-25 18:19:48', NULL, 'present', 0, 0.00),
	(8, 5, 1, '2026-03-25', '2026-03-25 21:33:57', NULL, 'present', 0, 0.00);
...
INSERT INTO `employees` (`id`, `user_id`, `employee_code`, `position`, `rate_type`, `rate_amount`, `date_hired`) VALUES
	...
	(5, 10, 'EMP000010', NULL, 'hourly', 0.00, NULL),
...
-- Dumping data for table egoessolution.offices: ~2 rows (approximately)
INSERT INTO `offices` (`id`, `name`, `address`, `working_start_time`, `working_end_time`, `team_leader`, `is_active`, `team_leader_user_id`) VALUES
	(1, 'office1', 'Tirad Pass', '21:00:00', '05:00:00', 'starktony', 1, 12),
	(3, 'office2', 'Terminal', '08:00:00', '17:00:00', 'jobert', 1, 8);
...
INSERT INTO `users` (`id`, `office_id`, `role`, `full_name`, `email`, `password_hash`, `profile_image`, `is_active`, `created_at`) VALUES
	...
	(6, 1, 'admin', 'Robert', 'robert@egoes.com', '$2y$10$6uhsYl7klCi/6iJUiTSg6efclQVDYwzwDmLXOMeCA4kGZ/f4JPkte', NULL, 1, '2026-03-24 14:45:37'),
